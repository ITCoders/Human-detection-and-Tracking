...
ap.add_argument("-m", "--mean-shift", type=int, default=-1,help="whether or not mean")
...
(rects, weights) = hog.detectMultiScale(image,hitThreshold=0,winStride=winStride,padding=padding, scale=args["scale"], useMeanshiftGrouping=meanShift)
print(len(rects))
